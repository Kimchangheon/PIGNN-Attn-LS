...
srun python main_datagen_multiproc_improved.py --no_save_y_matrix --runs 1500 --save_steps 100 --rows_per_task 20 --min_number_of_buses 4 --max_number_of_buses 512 --gridtype HVN --save_path /home/woody/iwi5/iwi5295h/large
